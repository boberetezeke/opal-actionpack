module ActionView
  ...
  module Helpers
    ...
    module FormTagHelper
      ...
      def self.embed_authenticity_token_in_remote_forms
        @@embed_authenticity_token_in_remote_forms
      end
      def self.embed_authenticity_token_in_remote_forms=(value)
        @@embed_authenticity_token_in_remote_forms = value
      end

      # OPAL: no need for authenticity token on client side
      ...
      private
        ...
        def form_tag_in_block(html_options, &block)
          ...
          # OPAL: no string concatenation available
          #output << content
          output += content
